...
function loadWidget(config) {
	...
	let userAction = false,
		userActionTimer,
		messageTimer,
		messageArray = ["螺蛳粉，酸辣粉，你更爱哪个呢？", "每天都要开心哦~", "嗨～快来逗我玩吧！", "家主是个汤包，欢迎来灌水！"];
	...
	(function welcomeMessage() {
		...
		if (location.pathname === "/") { // 如果是主页
			...
			else if (now > 11 && now <= 13) text = "中午了，工作了一个上午，想好午餐吃什么了嘛？";
			else if (now > 13 && now <= 17) text = "午后很容易犯困呢，今天的目标完成了嘛？";
			else if (now > 17 && now <= 19) text = "傍晚了！家主最喜欢的就是夕阳！";
